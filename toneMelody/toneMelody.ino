...
// notes in the melody:
int melody[] = {
  NOTE_C5,NOTE_D5,NOTE_E5,NOTE_F5,NOTE_G5,NOTE_G5,NOTE_F5,NOTE_E5,NOTE_D5,NOTE_C5
};
...
int melody2[] = {
  NOTE_G5,NOTE_F5,NOTE_E5,NOTE_G5,NOTE_F5,NOTE_E5,NOTE_D5
  };
int noteDurations2[] = {
   4, 4, 4, 4, 4, 4, 4
  };
...
if(nexttone)
{
  ...
  tone(4, melody[cnt], noteDuration);
  ...
  tone(4, melody2[cnt], noteDuration);
   pauseBetweenNotes = noteDuration * 1.30;
   nexttone=false;
   } 
    for(int i = 0; i < 8 ; i++){
